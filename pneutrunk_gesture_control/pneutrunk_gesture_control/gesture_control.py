...
from pneutrunk_gesture_control.cvfpscalc import CvFpsCalc
from pneutrunk_gesture_control.keypoint_classifier import KeyPointClassifier
from pneutrunk_gesture_control.point_history_classifier import PointHistoryClassifier
...
def main(args=None):
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                debug_image = draw_info_text(
                    ...
                    brect,
                    handedness,
                    keypoint_classifier_labels[hand_sign_id], # tuto dorob
                ...
                msg_gesture_cmd.data = info_text
        ...
        msg = bridge.cv2_to_imgmsg(debug_image, "bgr8")
